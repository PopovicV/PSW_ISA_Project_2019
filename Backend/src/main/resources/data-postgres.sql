...
insert into pacijent(id, ime, prezime, kontakt_telefon, adresa, grad, drzava, jbo, admin_aktivirao, pacijent_aktivirao) values (3, 'Pera', 'Peric', '0625487563', 'Bulevar Oslobodjenja 65', 'Novi Sad', 'Srbija', '168458536942565', 'NE', 'DA')
insert into korisnik (email, lozinka, uloga) values ('mika@gmail.com', '1', 'PACIJENT')
insert into pacijent(id, ime, prezime, kontakt_telefon, adresa, grad, drzava, jbo, admin_aktivirao, pacijent_aktivirao) values (4, 'Mika', 'Mikic', '06548759945', 'Rumenacka 46', 'Novi Sad', 'Srbija', '14875595554269', 'NE', 'DA')
...
insert into korisnik (id, email, lozinka, uloga) values (10, 'lukic.milan22@gmail.com', '1', 'LEKAR')
