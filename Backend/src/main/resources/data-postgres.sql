...
insert into korisnik (email, lozinka, uloga) values ('1', '1', 'ADMINISTRATOR_KLINIKE')
insert into administrator_klinike (id, ime, prezime, kontakt_telefon) values (2, 'Milan', 'Lukic', '1234567')